...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  settings: (
    <>
      ...
      <path d="M19.4 13a1.6 1.6 0 0 0 .3 1.8l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1.6 1.6 0 0 0-2.7 1.1V21a2 2 0 0 1-4 0v-.2A1.6 1.6 0 0 0 6.7 19l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1A1.6 1.6 0 0 0 3 13.6 1.6 1.6 0 0 0 2 12.2H2a2 2 0 0 1 0-4h.2A1.6 1.6 0 0 0 3.8 7a1.6 1.6 0 0 0-.3-1.8l-.1-.1a2 2 0 1 1 2.8-2.8l.1.1A1.6 1.6 0 0 0 9 3V2a2 2 0 0 1 4 0v.2A1.6 1.6 0 0 0 15.3 5l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1.6 1.6 0 0 0-.3 1.8z" />
    </>
  ),
